...
var testfiles = [];
testfiles.push({
    before: "owamp-master-ma.json",
    after: "owamp-branch-ma.json",
});
testfiles.push({
    before: "owamp-pscheduler-master-ma.json",
    after: "owamp-pscheduler-branch-ma.json",
});
testfiles.push({
    before: "nightly-before-ma-fixes-psconfig.json",
    after: "nightly-after-ma-fixes-psconfig.json",
});

testfiles.push({
    before: "nightly-before-ma-fixes.json",
    after: "nightly-after-ma-fixes.json",
});
    ...
    testfiles.forEach(function (testfile) {
        ...
        it("checks manually " + before, function (done) {
            ...
            fs.readFile(path + after, "utf8", function (err, data) {
                ...
                chai.expect(output_after).to.deep.equalInAnyOrder(
                    output_before
                );

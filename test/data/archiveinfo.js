...
archive_checks.push(
    ...
    out: 
        {"rabbit2-5efb409a47117561c498000a":{"archiver":"rabbitmq","data":{"_url":"amqp://mj82:123@rabbithost.example.org:12345","connection-expires":"PT1S","schema":2}}}
    }
    );
archive_checks.push(
    {
        name: "Rabbit SSL with username/pass",
        in: {"_id":"5ef6106042e7f049ba97671a","admins":["1"],"desc":"New Testspec","name":"config-archive1","archiver":"rabbitmq","data":{"_url":"amqps://rabbithost.example.org:12345","_username":"asdf","_password":"qwerty","exchange":"asdf","routing_key":"ere","connection_lifetime":2},"create_date":"2020-06-26T15:12:32.463Z","update_date":"2020-09-01T15:27:27.019Z","__v":0},
    out:
{"config-archive1-5ef6106042e7f049ba97671a":{"archiver":"rabbitmq","data":{"_url":"amqps://asdf:qwerty@rabbithost.example.org:12345","exchange":"asdf","routing-key":"ere","connection-expires":"PT2S","schema":2}}}
}
);
